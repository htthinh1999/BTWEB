...
<body>
	...
	<form action="ThemSV">
		<table>
			<tr>
				<td>
					<label for="txtMaSV">Mã Môn Học</label>
				</td>
				<td>
			...
			<tr>
				<td>
					<label for="txtTenSV">Thời Gian</label>
				</td>
				<td>
			...
			<tr>
				<td>
					<label for="txtLop">Giáo Viên</label>
				</td>
				<td>
	...
	<br>
	<h1>SỬA THÔNG TIN THỜI KHÓA BIỂU</h1>
	<form action="SuaSV">
		<table>
			<tr>
				<td>
	...
	<br>
	<h1>XÓA THÔNG TIN THỜI KHÓA BIỂU</h1>
	<form action="XoaSV">
		<table>
			<tr>
				<td>
					<label for="txtMaSV">Thời Gian</label>
				</td>
				<td>
			    	<input type="text" id="txtMaSV" name="txtMaSV">
				</td>
